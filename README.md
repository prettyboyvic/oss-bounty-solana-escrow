...
A bounded campaign (planned three windows, ceiling five) then continued. Its
three windows finalized chunks 279-283, 284-288, and 289-293: a total of 294
chunks are `CONFIRMED` and 97 are `PLANNED`, with zero `SENT` or `UNKNOWN`
chunks. Chunk index 294 remains `PLANNED` with a null signature, and the
program remains absent. See the
[R4N campaign window 279-283 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_279_283_2026-07-27.md),
[R4N campaign window 284-288 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_284_288_2026-07-27.md),
and
...
Its three windows finalized chunks 294-298, 299-303, and 304-308: at that point
309 chunks were `CONFIRMED` and 82 `PLANNED`. See the
...
and
[R4N campaign window 304-308 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_304_308_2026-07-27.md).

A subsequent campaign (planned two windows, ceiling three), gated on an
independent disposition of the prior `378/1` local validation anomaly, then
continued. Its two windows finalized chunks 309-313 and 314-318, reaching 319
`CONFIRMED`. See the
[R4N campaign window 309-313 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_309_313_2026-07-27.md)
and the
[R4N campaign window 314-318 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_314_318_2026-07-27.md).

A further campaign (planned two windows, ceiling three) then continued. Its two
windows finalized chunks 319-323 and 324-328, reaching 329 `CONFIRMED`. See the
[R4N campaign window 319-323 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_319_323_2026-07-27.md)
and the
[R4N campaign window 324-328 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_324_328_2026-07-27.md).

Another campaign (planned two windows, ceiling three) then continued. Its two
windows finalized chunks 329-333 and 334-338: a total of 339 chunks are
`CONFIRMED` and 52 are `PLANNED`, with zero `SENT` or `UNKNOWN` chunks. Chunk
index 339 remains `PLANNED` with a null signature, and the program remains
absent. See the
[R4N campaign window 329-333 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_329_333_2026-07-27.md)
and the
[R4N campaign window 334-338 checkpoint](docs/PHASE_2_R4N_CAMPAIGN_WINDOW_334_338_2026-07-27.md).
...
R4M is permanently blocked as `R4M_POST_INVOCATION_BLOCKED_PRE_LEASE_NOOP`.
Its sole uploader invocation was terminated at the external execution boundary
before lease acquisition, signing, sending, or telemetry creation. State and
buffer evidence remained unchanged, R4M replay is forbidden, and any future
live window requires a separately authorized R4N gate. See the
[R4M blocked report](docs/PHASE_2_R4M_BLOCKED_2026-07-23.md).
